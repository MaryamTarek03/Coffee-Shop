...
List<CoffeeModel> coffeeList = [
  CoffeeModel(
    ...
    description:
        'a top view of a cup of coffee with latte art on a dark surface. The coffee cup is white, and it’s accompanied by a silver spoon resting on the saucer. The latte art consists of a white pattern resembling a leaf or flower, contrasting against the brown color of the coffee. Both the cup and saucer are positioned on a dark, rustic wooden surface that adds contrast to the light color of the ceramic ware. The soft lighting highlights the creamy surface of the coffee and the wood grain beneath it, giving it an inviting ambiance. This cup of coffee is not just a beverage, it’s a work of art that promises a rich, flavorful experience. Enjoy your coffee! ☕',
  ...
  CoffeeModel(
    ...
    description:
        ...
        'The cappuccinos themselves look divine. The dark coffee underneath the foam promises a robust flavor, while the frothy top adds a creamy, velvety texture. The sprinkle of cocoa not only adds a touch of sweetness but also enhances the coffee’s aroma.'
        'The entire setup is placed on a dark, textured surface, possibly a stone counter top or a textured tablecloth, which adds to the cozy and inviting atmosphere. This isn’t just a coffee break, it’s a moment of pure indulgence, a symphony of flavors waiting to be enjoyed. Bon appétit! ☕🥐',
  ...
  CoffeeModel(
    ...
    description:
        'a feast for the eyes! It features a white ceramic cup filled with coffee, showcasing an intricate latte art design on its surface. The coffee looks rich and creamy, promising a taste that’s both robust and smooth. The latte art, a beautiful pattern that resembles a leaf or a heart, adds a touch of elegance to the drink.'
        ...
        'In the background, there’s another similar white ceramic cup and saucer set, slightly blurred to emphasize the focus on the foreground elements. A small potted plant with lush green leaves and blue flowers adds a fresh and vibrant touch to the scene.'
        'The overall setting suggests a cozy and inviting ambiance, enhanced by natural lighting illuminating the scene. This isn’t just a cup of coffee, it’s a moment of tranquility, a sensory experience waiting to be savored. Enjoy your coffee! ☕',
  ...
  CoffeeModel(
    ...
    description:
        ...
        'The soft lighting highlights the creamy texture of the coffee and the grain of the wood, creating an inviting ambiance that makes you want to reach out and take a sip. This isn’t just a cup of coffee, it’s a moment of indulgence, a sensory experience waiting to be savored. Enjoy your coffee! ☕',
